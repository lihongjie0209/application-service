module github.com/lihongjie0209/application-service
...
require (
	...
	github.com/lihongjie0209/microservice-platform-go v0.15.10
	github.com/lihongjie0209/platform-protos v0.50.0
