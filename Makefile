...
LDFLAGS = -s -w -X github.com/lihongjie0209/application-service/internal/buildinfo.Version=$(VERSION) -X github.com/lihongjie0209/application-service/internal/buildinfo.Commit=$(COMMIT) -X github.com/lihongjie0209/application-service/internal/buildinfo.BuildTime=$(BUILD_TIME)
...
docker-build:
	docker build \
		...
		--tag application-service:$(VERSION) .
